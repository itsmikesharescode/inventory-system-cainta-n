...
ALTER TABLE ONLY "public"."borrowed_items_tb"
    ADD CONSTRAINT "borrowed_items_tb_room_id_fkey" FOREIGN KEY ("room_id") REFERENCES "public"."entries_rooms_tb"("id") ON DELETE CASCADE;
...
ALTER TABLE ONLY "public"."reservations_tb"
    ADD CONSTRAINT "reservations_tb_room_id_fkey" FOREIGN KEY ("room_id") REFERENCES "public"."entries_rooms_tb"("id") ON DELETE CASCADE;
