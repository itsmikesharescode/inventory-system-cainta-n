...
<script lang="ts" generics="TData, TValue">
  ...
  import type { AddRoomSchema } from '../../add-room/schema';

  interface Props {
    addRoomForm: SuperValidated<Infer<AddRoomSchema>>;
    columns: ColumnDef<RoomsPageTable, unknown>[];
    data: RoomsPageTable[];
  }

  let { addRoomForm, columns, data }: Props = $props();
...
<div class="space-y-4">
  <TableToolbar {addRoomForm} {table} />
