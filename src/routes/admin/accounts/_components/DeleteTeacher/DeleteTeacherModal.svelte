...
<AlertDialog.Root bind:open={showDeleteTeacher}>
  <AlertDialog.Content>
    <AlertDialog.Header>
      <AlertDialog.Title>Delete this teacher?</AlertDialog.Title>
      <AlertDialog.Description>
        This action cannot be undone. This will permanently delete the teacher in our database.
      </AlertDialog.Description>
    </AlertDialog.Header>
