...
<script lang="ts" generics="TData, TValue">
  ...
  import type { AddReturneeSchema } from '../../add-returnee/schema';

  interface Props {
    addReturneeForm: SuperValidated<Infer<AddReturneeSchema>>;
    columns: ColumnDef<ReturneePageTable, unknown>[];
    data: ReturneePageTable[];
  }

  let { addReturneeForm, columns, data }: Props = $props();
...
<div class="space-y-4">
  <TableToolbar {addReturneeForm} {table} />
