...
<script lang="ts" generics="TData, TValue">
  ...
  import type { AddCategorySchema } from '../../add-category/schema';

  interface Props {
    addCategoryForm: SuperValidated<Infer<AddCategorySchema>>;
    columns: ColumnDef<CategoriesPageTable, unknown>[];
    data: CategoriesPageTable[];
  }

  let { addCategoryForm, columns, data }: Props = $props();
...
<div class="space-y-4">
  <TableToolbar {addCategoryForm} {table} />
